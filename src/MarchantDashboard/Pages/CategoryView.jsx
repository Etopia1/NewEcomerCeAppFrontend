...
//     console.log(token)
//     const handleEdit = () =>{
//         axios.get(`http://localhost:1900/api/v1/category/${id}`)
//         .then((res)=>{
//             console.log(res)
...
const CategoryView = () => {
  ...
  const fetchCategory = async () => {
    try {
      const response = await axios.get(`http://localhost:1900/api/v1/category/${id}`, {
  ...
  const handleDelete = async () => {
    try {
        const response =  await axios.delete(`http://localhost:1900/api/v1/category/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      console.log(response)
