...
import { AddmarchantData, AddMarchantId, AddMarchanttoken, Addtoken, AddUserId, AllData } from '../components/Global/Slice';
...
const UserLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:1900/api/v1/user-login', { email, password });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 py-6">
      <div className="bg-white h-[90%] p-8 rounded-lg shadow-md w-[90%] max-w-lg">
        ...
        <div className="mt-4 text-center">
          <Link to="/user-forgetpass" className="text-sm text-indigo-600 hover:underline">
            Forgot Password?
          </Link>
        </div>
